...
**Weiterhin nicht verifiziert:** der Entsperren-Pfad bei einem Neustart (falsches Passwort → Ablehnung, korrektes Passwort/Wiederherstellungscode → Entsperren), der Crash-Erholungspfad, und die tatsächliche Argon2id-Laufzeit auf echter Hardware — dieser Test-Install hatte einen nicht gespeicherten Wiederherstellungscode (bewusst in Kauf genommen, reine Testdaten ohne echten Vereinsbezug), wodurch ein "Passwort vergessen"-Test hier nicht sinnvoll durchführbar war, ohne den Tresor unwiderruflich zu sperren.
